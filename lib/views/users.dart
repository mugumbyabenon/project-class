...
class _UploadState extends State<Upload> {
  ...
  File? _image3;
  String imageUrl =
      'https://t4.ftcdn.net/jpg/01/67/65/73/360_F_167657302_FNkJP5s2AUCzQwiKwmO9PV2JkcC6l8Zr.jpg';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.white, body: MyWidget());
  }
}
              ...
              onPressed: (() async {
                ...
                Future<void> addUser(
                  ...
                  if (user != null) {
                    ...
                    log('$button');
                    Navigator.of(context).pushNamed(homeRoutes);
                  } else {
                ...
                try {
                  final imagesUrls = await upload(images) ??
                    ...
                    if (_rate.text.isNotEmpty) {
                      ...
                      if (car <= 20) {
                        ...
                        await showErrorDialog(context,
                            '${_rate.text.trim()}% is very a high rate. Try a manageable rate that is below 20%');
                      }
                    } else {
                      addUser(
                          _firstname.text.trim(),
            ...
            child: BackdropFilter(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Posting your advert please wait',
                    style: TextStyle(
                        color: Colors.red,
                        fontSize: 15,
                        fontWeight: FontWeight.bold),
