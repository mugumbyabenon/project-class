  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
          child: Stack(
                     ...
                     //  color: CupertinoColors.activeOrange,
                      ...
                      onPressed: (() async {
                       CollectionReference users = FirebaseFirestore.instance.collection('Adverts');
                        ...
                        final imagesUrl1,final imagesUrl2,final imagesUrl3,final rates) async {
            ...
            await         addUser(_firstname.text.trim(),  
                  ...
                  sigmaY: 1.0,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Posting your advert please wait',style: TextStyle(color: Colors.red,fontSize: 15,fontWeight: FontWeight.bold),)
                        ],
                      ),
                    ),
                  ),
