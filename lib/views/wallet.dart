  ...
  Widget build(BuildContext context) {
    ...
    if (user != null) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          '${data?['Deposit_Button'] ?? "Pending Balance"}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 20),
                                        ),
                                        ...
                                        Text(
                                          'Shs.${myFormat.format(int.parse(data?['Intial Deposit'] ?? "${data?['Balance'] ?? 0}"))}',
                                          style: TextStyle(
                                    ...
                                    Text(
                                      'Shs.${myFormat.format(int.parse(data?['MonthlyFee'] ?? ""))}',
                                      style: TextStyle(fontSize: 20),
                                    ),
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.02),
                                    Text(
                                      '${data?['PaymentPeriodButton'] ?? "Loan End Date"}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20),
                                    ),
                                    ...
                                    Text(
                                      '${data?['PaymentPeriod'] ?? "${data?['Loan End Date'] ?? "Loan End Date"}"}',
                                      style: TextStyle(fontSize: 20),
                                    ),
                                    SizedBox(
                                        height:
                                    ...
                                    Text(
                                      '${data?['delivery'] ?? "Shs.${myFormat.format(data?['Paid Money'] ?? "")}"}',
                                      style: TextStyle(fontSize: 20),
                                    ),
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.02),
                                    Text(
                                      '${data?['app date'] ?? "Loan Start Date".toString()}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20),
                                    ),
                                    ...
                                    Text(
                                      '${data?['Application Date'] ?? "${data?['Loan Start Date'] ?? ""}".toString()}',
                                      style: TextStyle(fontSize: 20),
                                    ),
                                    SizedBox(
                                        height:
      ...
      return AlertDialog(
        title: const Text('Join our Family Today '),
        content: Text(
            'Pay Loans seamlessly with our user friendly interface at the lowest rates'),
        actions: [
          TextButton(
              onPressed: () {
                Navigator.of(context).pop();
...
class AdvertDetails extends StatefulWidget {
  ...
  AdvertDetails(this.myParam, this.price, this.carname, this.image,
      this.sellerid, this.email, this.rate, this.advertpk);
...
class _AdvertDetailsState extends State<AdvertDetails> {
  ...
  Widget build(BuildContext context) {
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                              child: Text(
                                  'Shs.${myFormat.format(widget.price)}',
                                  ...
                                  children: [
                                    ...
                                    Text('Dealer Details',
                                        style: GoogleFonts.poppins(
                                            fontSize: 20,
                                            color: Colors.orange)),
                                    DealerDetails('${data?['email'] ?? ""}',
                                        '${data?['Used or Brand New'] ?? ""}'),
                                    SizedBox(
                                      height:
                                          MediaQuery.of(context).size.height *
                                              0.01,
    ...
    return AlertDialog(
      title: const Text('Join our Family Today '),
      content:
          Text('Reach Out to thousands of customers or obtain unsecured loans'),
      actions: [
        TextButton(
            onPressed: () {
              Navigator.of(context).pop();
