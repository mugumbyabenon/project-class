...
class _NotesViewState extends State<NotesView> {
  ...
  List<Widget> screens = [HomeInterface(), Upload(), Wallet(), UserProfile()];
  List<Widget> admin = [HomeInterface(), ApprovalLoan(), UserProfile()];
                      ...
                      switch (value) {
                        ...
                        case MenuAction.loans:
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Category('Request Loan/Buy', 'button')),
                          );
                          break;
                      }
                    }),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          'Shs.${myFormat.format(data?['Price'] ?? 0)}',
...
class AdvertDetails extends StatefulWidget {
  ...
  AdvertDetails(this.myParam, this.price, this.carname, this.image,
      this.category, this.sellerid, this.email, this.rate, this.advertpk);
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                          child: Text('Shs.${myFormat.format(widget.price)}',
                          ...
                          onPressed: () async {
                            ...
                            if (user != null) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text(
                                          'Please login inorder to apply for loan')));
                            }
                          },
                                          ...
                                          if (user != null) {
                                            ...
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(const SnackBar(
                                                    content: Text(
                                                        'Please login inorder to write your comment')));
                                          }
                                        },
                                        child: Text('Comment'))
                                  ],
